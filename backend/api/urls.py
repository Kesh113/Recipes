...
from .views import IngredientViewSet, TagViewSet, RecipeViewSet, UserViewSet, SubscribeViewSet, GetLinkView, FavoriteView, ShoppingCartView, DownloadShoppingCartView
